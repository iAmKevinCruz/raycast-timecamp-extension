...
export default function Command() {
  ...
  const { mutate: mutateActiveTask, revalidate: revalidateActiveTask } = useFetch("https://app.timecamp.com/third_party/api/timer", {
    method: "POST",
    headers: {
  ...
  return (
    ...
    >
      ...
      <RecentEntries
        revalidateActiveTask={revalidateActiveTask}
      />
